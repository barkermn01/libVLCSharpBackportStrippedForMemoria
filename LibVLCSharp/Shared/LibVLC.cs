...
namespace LibVLCSharp.Shared
{
    ...
    public class LibVLC : Internal
    {
        ...
        static ExitCallback _exitCallback;
        ...
        static void OnDisplayError(string title, string text)
        {
            _error?.Invoke(title, text);
        }

        static void OnDisplayLogin(IntPtr dialogId, string title, string text, string defaultUsername, bool askStore)
        {
        ...
        static void OnDisplayQuestion(IntPtr dialogId, string title, string text, DialogQuestionType type,
        ...
        static void OnDisplayProgress(IntPtr dialogId, string title, string text, bool indeterminate, float position, string cancelText)
        {
        ...
        static void OnCancel(IntPtr dialogId)
        {
        ...
        static void OnUpdateProgress(IntPtr dialogId, float position, string text)
        {
