...
namespace LibVLCSharp.Shared
{
    ...
    public class MediaPlayer : Internal
    {
        ...
        public Media Media
        {
            ...
            set => Native.LibVLCMediaPlayerSetMedia(NativeReference, value == null? IntPtr.Zero: value.NativeReference);
        }
        ...
        {
            if(playCb == null) throw new ArgumentNullException(nameof(playCb));
            _audioPlayCb = playCb;
        ...
        {
            if (_setupCb == null) throw new ArgumentNullException(nameof(setupCb));  
            _setupCb = setupCb;
        ...
        {
            if (lockCb == null) throw new ArgumentNullException(nameof(lockCb));
            _videoLockCb = lockCb;
        ...
        {
            if (_videoFormatCb == null) throw new ArgumentNullException(nameof(formatCb));
        ...
        public bool SetRenderer(RendererItem rendererItem) =>
            Native.LibVLCMediaPlayerSetRenderer(NativeReference, rendererItem == null? IntPtr.Zero:rendererItem.NativeReference) == 0;
